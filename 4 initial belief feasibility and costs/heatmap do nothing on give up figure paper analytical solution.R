results <- read.csv(heatmap_maxTime_file_varying_transitions_analytical, sep=" ",
                 header=FALSE)
...
ggsave(heatmap_maxTime_figure_varying_transitions_analytical,
       plot = max_time_heatMap, width = 10, height = 6, units = "in")

##modify map####
svglite(heatmap_maxTime_figure_varying_transitions_analytical)
max_time_heatMap
