...
ggsave(AM_strategy_varying_priors_example_figure,
       plot = AM_strategy_plot, width = 10, height = 6, units = "in")

# AM_strategy_plot+
#   new_scale_fill()+
#   geom_raster(data=res,
#               aes(x = belief_benef_low, y = belief_benef_high,
#                   fill=(value_AM_infty-value_noRD_infty)/value_noRD_infty*100,
#                   alpha=0.5),
#               interpolate = TRUE) +
#   scale_fill_gradient(low = "white", high = "black")+
#   geom_contour(data=res,
#                aes(x = belief_benef_low, y = belief_benef_high,
#                    z = (value_AM_infty-value_noRD_infty)/value_noRD_infty*100),
#              binwidth = 0.05,
#              breaks = breaks_countour,
#              colour = "black") +
#   metR::geom_text_contour(data=res,
#                           aes(x = belief_benef_low, y = belief_benef_high,
#                               z = (value_AM_infty-value_noRD_infty)/value_noRD_infty*100),
