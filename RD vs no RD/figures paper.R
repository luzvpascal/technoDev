results <- read.csv(heatmap_valueNoRD_valueRD_varying_transitions_file,
                    header = FALSE)
names(results) <- c("tr_low_low","tr_high_low","value_noRD","value_RD")
...
ggsave(heatmap_valueNoRD_valueRD_varying_transitions_figure,
       plot = heatmap_plot, width = 12, height = 6, units = "in")
# ##modify map####
# svglite(heatmap_valueNoRD_valueRD_varying_transitions_figure)
# heatmap_plot
